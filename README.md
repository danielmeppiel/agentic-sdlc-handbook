...
By [Daniel Meppiel](https://www.linkedin.com/in/danielmeppiel/) — Software Global Black Belt at Microsoft, creator of [APM](https://github.com/microsoft/apm) and the [PROSE framework](https://danielmeppiel.github.io/awesome-ai-native).
...
- **The [PROSE framework](https://danielmeppiel.github.io/agentic-sdlc-handbook/handbook/ch12-the-prose-specification.html)** — a specification methodology for writing AI agent instructions, developed through building APM
