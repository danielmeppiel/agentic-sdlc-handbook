---
pagetitle: "The Cross-Harness Reference"
---
...
## At a glance — the substrate matrix
...
| Session compaction / restart[^appx-a-compact] | `/compact` (Copilot CLI session compaction) | `/compact` (Claude Code) | (manual: new chat / "Reset context" in chat header) | `/new` (Codex CLI session refresh) | `/compact` (OpenCode) |
...
## agentskills.io as the cross-harness convergence {#sec-skills-convergence}
