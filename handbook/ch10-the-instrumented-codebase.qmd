...
For a production-scale skill the reader already has on disk, see `skills/genesis/SKILL.md` — the same activation contract this section teaches, in operational form.[^ch10-genesis-skill]
...
[^ch10-genesis-skill]: `skills/genesis/SKILL.md` carries the activation contract under the "Hard rules" heading — the description-driven trigger and the process body the dispatcher reads — alongside `skills/genesis/agents/genesis-architect.agent.md` as the persona-scoping artifact in the same bundle. *Agent-side reference; bundle layout.*
