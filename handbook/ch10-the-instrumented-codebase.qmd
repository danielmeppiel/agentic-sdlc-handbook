...
For a production-scale skill the reader can inspect, see [`skills/genesis/SKILL.md`](https://github.com/danielmeppiel/genesis/blob/main/skills/genesis/SKILL.md) in [`danielmeppiel/genesis`](https://github.com/danielmeppiel/genesis) — the same activation contract this section teaches, in operational form.[^ch10-genesis-skill]
...
[^ch10-genesis-skill]: [`skills/genesis/SKILL.md`](https://github.com/danielmeppiel/genesis/blob/main/skills/genesis/SKILL.md) carries the activation contract under the "Hard rules" heading — the description-driven trigger and the process body the dispatcher reads — alongside [`skills/genesis/agents/genesis-architect.agent.md`](https://github.com/danielmeppiel/genesis/blob/main/skills/genesis/agents/genesis-architect.agent.md) as the persona-scoping artifact in the same bundle. *Agent-side reference; bundle layout.*
