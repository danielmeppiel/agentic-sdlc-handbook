...
Early implementations already exist. Open-source tools provide manifest-based dependency resolution and security scanning for agent configuration — the same architecture as npm or pip, applied to agent configuration rather than runtime code.
