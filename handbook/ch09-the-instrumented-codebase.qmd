...
- **Agents, Skills, and Prompts** have the deepest native support in GitHub Copilot's `.agent.md`, `SKILL.md`, and `.prompt.md` formats. **Hooks** are natively supported by Copilot, Cursor, and Claude Code; other tools achieve similar outcomes through their own configuration mechanisms.
