...
**Cross-link — Ch13.** Truth #1 is the attention-economy point in operational form: see @sec-attention-economy. The substrate vocabulary the corrected design relies on lives in `skills/genesis/assets/runtime-affordances/common.md`.
:::
...
The Compliance summary above flips four rows from FAIL to PASS once the fan-out is in place; Single-writer was already PASS but now holds by construction rather than by coincidence of the loop. For a denser instance with six personas plus an arbiter against a real PR-review surface, see `skills/genesis/examples/04-pr-review-advisory.md`.
