...
**Author disclosure.** Genesis is built by the author of this book and is the implementation this appendix walks through. It is one of several emerging answers to the discipline the practitioner chapters argue for, MIT-licensed and open source. The mechanics it demonstrates — Panel anti-pattern, fan-out fix, compliance check — port to any package-managed primitive set; the file paths and slash commands do not.
:::
