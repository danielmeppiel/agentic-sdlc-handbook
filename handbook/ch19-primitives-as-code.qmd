...
[^ch19-genesis]: The agent-side companion `danielmeppiel/genesis` enumerates an analogous composition substrate (skill / bundle / dependency / override) under a different surface vocabulary used by agents; per the directionality contract of this book, it appears here only as agent-side reference, not as load-bearing structure. *Agent-side reference; substrate concept.*
