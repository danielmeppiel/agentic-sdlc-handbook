...
flowchart LR
    ...
    style HUMAN fill:#2874a6,stroke:#1a5276,color:#fff
    style AGENT fill:#f39c12,stroke:#e67e22,color:#1a1a1a
    style PLATFORM fill:#196f3d,stroke:#145a32,color:#fff
```
...
| **Data Context** | Business intelligence, domain models, analytics, ontologies | Data dictionaries, domain glossaries, schema docs | BI platforms, data catalogs, knowledge graphs |
