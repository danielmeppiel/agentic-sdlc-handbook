...
flowchart TD
    ...
    Q1 -- Yes --> FIX1["Model issue<br/>Upgrade or manual"]
    Q1 -- No --> Q2{"Tests fail?"}

    Q2 -- Yes --> Q2a{"Agent's code<br/>or pre-existing?"}
    Q2a -- "Agent's" --> FIX2["Task/context issue<br/>Narrow scope"]
    ...
    Q4 -- No --> FIX4["Architecture issue<br/>Fix boundaries"]
...
::: {.callout-tip appearance="simple" icon=false}
**Spotting new anti-patterns regularly?** Read the latest version at [danielmeppiel.github.io/apm-handbook](https://danielmeppiel.github.io/apm-handbook/) · Follow on [LinkedIn](https://www.linkedin.com/in/danielmeppiel/)
:::
:::
