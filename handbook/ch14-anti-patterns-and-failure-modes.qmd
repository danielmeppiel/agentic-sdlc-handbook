...
flowchart TD
    ...
    style FIX2 fill:#f39c12,color:#1a1a1a
    style FIX3 fill:#f39c12,color:#000
    style FIX4 fill:#f39c12,color:#000
    style FIX5 fill:#196f3d,color:#fff
    style FIX2b fill:#2874a6,color:#fff
```
...
These risks aren't unique to AI-generated code — they're amplified by volume. An agent generating 75 files in 90 minutes produces more review surface area than a human in the same timeframe. Review discipline must scale with generation speed.
