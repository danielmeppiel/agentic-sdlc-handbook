...
- **`harness`** -- the runtime application Chapter 4 called "agent runtime". Codex CLI, Claude Code, Copilot, Cursor, OpenCode. Chapter 11 (@sec-runtime-machine) is the canonical practitioner treatment.
...
- **`recursion bound`** -- the operational limit (context budget plus panel-orchestration policy) that keeps the dispatch tree from running away. Treated in Chapter 17.
