...
4. **Inference is per-thread; the filesystem is shared.** Threads are amnesiac; the filesystem is the only memory that persists. Every coordination pattern in the rest of this book follows from that asymmetry.
:::
