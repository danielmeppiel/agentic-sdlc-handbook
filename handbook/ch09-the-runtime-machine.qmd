...
The story below uses three filename shapes that recur across every harness. If they are new, here is enough to read on without losing the thread. Chapter 10 (@sec-instrumented-codebase) catalogues all seven primitive types with full examples and design tests.
...
For the rest of this chapter, treat these three as concrete instances of the broader category this chapter will name *the filesystem-as-loader*.
:::
