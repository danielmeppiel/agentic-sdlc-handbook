...
graph TD
    P["P<br/>Progressive<br/>Disclosure"] <-- "controls attention<br/>within scope" --> E["E<br/>Explicit<br/>Hierarchy"]
    R["R<br/>Reduced<br/>Scope"] <-- "constrains what<br/>safety must cover" --> S["S<br/>Safety<br/>Boundaries"]
    O["O<br/>Orchestrated<br/>Composition"] <-- "single source of<br/>truth across tasks" --> R
    P <-- "loads only what<br/>fits in scope" --> R
    E <-- "hierarchy defines<br/>boundary scope" --> S
...
Read the latest version at [danielmeppiel.github.io/agentic-sdlc-handbook](https://danielmeppiel.github.io/agentic-sdlc-handbook/) · Follow on [LinkedIn](https://www.linkedin.com/in/danielmeppiel/)
:::
:::
