...
The ADAPT loop connects wave execution back to planning. It is not a fallback. It is a designed part of the process — the mechanism that handles the irreducible uncertainty of working with non-deterministic systems on complex codebases. It is also one instance of the broader Reconciliation Loop style catalogued in Ch18 (@sec-control-loop-patterns); the operational fields named there (Invariant, Convergence, Failure Mode) apply here at the wave level.
