...
[^ch11-genesis-prose]: *"classic + PROSE + LLM-physics compliance check"* — that is the verbatim label of **Step 5, compliance check** in [`skills/genesis/SKILL.md`](https://github.com/danielmeppiel/genesis/blob/613f2a64a4a193cacd45fd4439a093044ae3178d/skills/genesis/SKILL.md): *"apply the PROSE constraints (Progressive Disclosure, Reduced Scope, Orchestrated Composition, Safety Boundaries, Explicit Hierarchy) and the seven durable LLM truths. Any BLOCKER stops the design; return to step 2."* PROSE compliance is gated at design time, before any module body is drafted. *Agent-side reference; Step 5 verbatim.*
