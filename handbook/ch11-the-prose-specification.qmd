...
[^ch11-genesis-prose]: For PROSE constraints in operational form, see the "Hard rules" section of `skills/genesis/SKILL.md` and the Tier-0 head of `skills/genesis/assets/primitives.md`, which encode progressive disclosure, reduced scope, and the orchestrated-composition stance as a checklist the dispatcher reads before any module body loads. *Agent-side reference; PROSE in operational form.*
