...
```{mermaid}
%%| fig-width: 4.5
%%| fig-cap: "The five PROSE specification principles and their relationships"
%%| fig-alt: "A flowchart showing five PROSE principles arranged in a hierarchy. Explicit Hierarchy filters rules into Progressive Disclosure, which fills Reduced Scope, which decomposes into Orchestrated Composition. Safety Boundaries constrains all execution of Orchestrated Composition and limits the scope of Reduced Scope. The flow is left to right with Safety Boundaries acting as a cross-cutting constraint on the other four principles."
%%| label: fig-prose-principles
flowchart LR
    subgraph " "
        direction TB
...
Block 2 (Chapters 8–19) answers those questions. It teaches context engineering as a disciplined practice: how to build context budgets, design instruction hierarchies, create agent configurations, and orchestrate multi-step workflows across real codebases. It walks through the meta-process: audit your codebase for context gaps, plan the artifact architecture, execute in waves, validate against real output, ship. Every chapter includes worked examples with specific numbers, before-and-after comparisons, and anti-patterns drawn from real failures.
...
**Found this useful?** Get the full handbook as a formatted PDF or EPUB. [📕 Download -->](../download.qmd) · Follow on [LinkedIn](https://www.linkedin.com/in/danielmeppiel/)
:::
:::
:::
...
::: {.callout-tip appearance="simple" icon=false}
**Found this useful?** Read the latest version at [danielmeppiel.github.io/agentic-sdlc-handbook](https://danielmeppiel.github.io/agentic-sdlc-handbook/)\
...
[^ch1-context]: GPT-3 supported 2,048 tokens (Brown et al., 2020). GPT-4 Turbo expanded to 128K tokens (OpenAI DevDay, November 2023). Gemini 1.5 Pro reached 1M tokens ([Google, February 2024](https://blog.google/technology/ai/google-gemini-next-generation-model-february-2024/)). Claude 3 launched with 200K tokens ([Anthropic, March 2024](https://www.anthropic.com/news/claude-3-family)).

[^ch1-satisfaction]: In the 2024 Stack Overflow Developer Survey, 45% of professional developers rated AI tools as "bad" or "very bad" at handling complex tasks, even as overall AI adoption reached 76%. See [survey.stackoverflow.co/2024/ai](https://survey.stackoverflow.co/2024/ai).

[^ch1-rework]: Multiple data points support this range: the 2025 Stack Overflow Developer Survey found 66% of developers report AI-generated solutions as "almost right, but not quite"; GitClear's 2025 analysis of 211M lines of code showed code quality metrics degrading with AI adoption; and their 2026 analysis found heavy AI users produce 9× more code churn than non-users. See [survey.stackoverflow.co/2025/ai](https://survey.stackoverflow.co/2025/ai) and [gitclear.com/ai_assistant_code_quality_2025_research](https://www.gitclear.com/ai_assistant_code_quality_2025_research).

[^ch1-karpathy]: Andrej Karpathy, keynote at UC Berkeley AI Hackathon 2024. https://youtu.be/tsTeEkzO9xc
