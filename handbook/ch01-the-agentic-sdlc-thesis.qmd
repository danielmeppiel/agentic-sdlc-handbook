...
These constraints sound abstract. Later in this book, we trace a single pull request — [75 files changed, 2,897 tests passing, 3 execution-phase interventions (5 total including verification), roughly 90 minutes of wave execution time](https://github.com/microsoft/apm/pull/394) — that demonstrates what they produce in practice. That case study shows both what worked and what required human escalation. It is evidence, not a sales pitch. The full metrics are in [The APM Auth + Logging Overhaul](case-study-apm-overhaul.qmd) case study.
...
::: {.callout-tip appearance="simple" icon=false}
**Found this useful?** Read the latest version at [danielmeppiel.github.io/agentic-sdlc-handbook](https://danielmeppiel.github.io/agentic-sdlc-handbook/) · Follow on [LinkedIn](https://www.linkedin.com/in/danielmeppiel/)
:::
:::
