...
flowchart TD
    ...
    style DELEGATE fill:#196f3d,stroke:#145a32,color:#fff
    style SPLIT fill:#196f3d,stroke:#145a32,color:#fff
    style MANUAL1 fill:#2874a6,stroke:#1a5276,color:#fff
    style MANUAL2 fill:#2874a6,stroke:#1a5276,color:#fff
    style MANUAL3 fill:#2874a6,stroke:#1a5276,color:#fff
```
