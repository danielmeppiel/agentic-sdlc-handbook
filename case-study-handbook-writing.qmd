---
title: "Writing a 67,000-Word Book with Agent Fleets"
number-sections: false
---

**Scope:** 15 chapters, ~67,000 words — full technical book on AI-native software development  
...
%%| fig-alt: "Flowchart showing three process gaps that triggered dynamic persona creation. First path: Integration Review where editor reads all 15 chapters leads to a decision node asking if visual anchors are missing. Yes leads to creating the Illustrator Agent (Visual Strategist persona), which produces a fleet of 2 agents finding 40 visual opportunities and embedding 24 Mermaid diagrams. Second path: Integration Review leads to a decision node asking if inconsistent statistics exist across chapters. Yes leads to creating the Fact-Ref-Checker (Claims Auditor persona), which produces a fleet of 2 agents finding 75 flags including 5 critical ones. Third path: The question 'How to publish?' leads to a decision node asking if publishing expertise is needed. Yes leads to creating the Publishing Advisor, which evaluates 5 paths and recommends Open Core plus Premium model."
...
flowchart TD
    ...
    C --> D[Fleet of 2: Block 1 + Block 2<br/>40 visual opportunities<br/>24 Mermaid diagrams embedded]
...
**What happened:** After the "zero APM mentions in ~67,000 words" discovery, the Market Analyst wanted more visibility; the Thought Leadership Advisor wanted less. The panel genuinely disagreed.
...
A book about AI-native software development, written by APM's creator, using APM's orchestration infrastructure, contained zero mentions of APM across ~67,000 words. This was not a bug — it was the methodology working correctly. Each agent was dispatched with chapter-specific scope; no agent had "promote the author's project" in its persona. The absence proved the review process was honest and prompted the four-wave strategic assessment that produced the surgical insertions above.
...
~67,000 words · 15 chapters · 11 personas (8 + 3 dynamic) · ~50+ dispatches · 4 writing waves + integration + polish · 24 Mermaid diagrams · 75 fact-check flags (5 critical) · 40 visual opportunities · 5 APM mentions (~475 words) · 4 escalation events · 5/5 structural properties tested
:::
