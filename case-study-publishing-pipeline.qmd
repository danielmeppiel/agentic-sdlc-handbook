...
sequenceDiagram
    ...
    O->>P: Evaluate licensing<br/>for free tech book
    P->>P: IP Attorney: protects<br/>canonical version
    P->>P: Strategist: sharing<br/>+ attribution
    P->>P: Growth: max reach,<br/>protect monetization
    P->>O: Unanimous: CC BY-NC-ND 4.0
    O->>H: Recommendation + rationale
    H->>O: Approved
    O->>O: Apply to LICENSE, README,<br/>index, _quarto.yml
```
