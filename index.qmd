...
systems. Summon it in your agent with `/genesis <what you want
designed>` and it returns a named pattern, an execution diagram, an
acceptance test, and a written plan before a single file is touched.
