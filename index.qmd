...
With 14+ years spanning pre-sales, post-sales, product strategy, and enterprise adoption, Daniel bridges the gap between technical architecture and business outcomes. He founded and ran **Wegaw** as CTO for 4 years -- an AI-powered water intelligence startup serving European energy companies. Before Microsoft, he worked at **GitHub** on developer tooling and at **CERN** on Product Lifecycle Management modernization for particle physics experiments -- large legacy system transformation, the same class of problem AI agents now target in the SDLC.
