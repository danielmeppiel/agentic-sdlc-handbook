...
::: {.callout-note title="Before you read Part III: a free companion"}
Part III is the design-discipline block of the book — the chapters that
teach how to build non-trivial agent-driven systems.

You can read it on its own. If you want the same patterns loaded into
the AI you code with while you read, install the companion:
...
as the book and inspectable in full at
